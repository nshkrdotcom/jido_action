defmodule Jido.Action.Error do
  ...
  ## Examples
      ...
      iex> Jido.Action.Error.new(:config_error, "Invalid configuration")
      %Jido.Action.Error{
        type: :config_error,
      ...
      iex> Jido.Action.Error.new(:execution_error, "Exec failed", %{step: "data_processing"})
      %Jido.Action.Error{
  ...
  ## Example
      ...
      iex> Jido.Action.Error.invalid_action("Action 'MyAction' is missing required callback")
      %Jido.Action.Error{
        type: :invalid_action,
  ...
  ## Example
      ...
      iex> Jido.Action.Error.invalid_sensor("Sensor 'MySensor' is missing required callback")
      %Jido.Action.Error{
        type: :invalid_sensor,
  ...
  ## Example
      ...
      iex> Jido.Action.Error.bad_request("Missing required parameter 'user_id'")
      %Jido.Action.Error{
        type: :bad_request,
  ...
  ## Example
      ...
      iex> Jido.Action.Error.validation_error("Invalid email format", %{field: "email", value: "not-an-email"})
      %Jido.Action.Error{
  ...
  ## Example
      ...
      iex> Jido.Action.Error.config_error("Invalid database connection string")
      %Jido.Action.Error{
        type: :config_error,
  ...
  ## Example
      ...
      iex> Jido.Action.Error.execution_error("Failed to process data", %{step: "data_transformation"})
      %Jido.Action.Error{
        type: :execution_error,
  ...
  ## Example
      ...
      iex> Jido.Action.Error.planning_error("Failed to plan action", %{step: "goal_analysis"})
      %Jido.Action.Error{
        type: :planning_error,
  ...
  ## Example
      ...
      iex> Jido.Action.Error.action_error("Exec 'ProcessOrder' failed", %{order_id: 12345})
      %Jido.Action.Error{
        type: :action_error,
  ...
  ## Example
      ...
      iex> Jido.Action.Error.internal_server_error("Unexpected error in data processing")
      %Jido.Action.Error{
  ...
  ## Example
      ...
      iex> Jido.Action.Error.timeout("Exec timed out after 30 seconds", %{action: "FetchUserData"})
      %Jido.Action.Error{
        type: :timeout,
  ...
  ## Example
      ...
      iex> Jido.Action.Error.invalid_async_ref("Invalid or expired async action reference")
      %Jido.Action.Error{
  ...
  ## Example
      ...
      iex> Jido.Action.Error.routing_error("Invalid route configuration", %{route: "user_action"})
      %Jido.Action.Error{
        type: :routing_error,
  ...
  ## Example
      ...
      iex> Jido.Action.Error.dispatch_error("Failed to deliver signal", %{adapter: :http, reason: :timeout})
      %Jido.Action.Error{
        type: :dispatch_error,
  ...
  ## Examples
      ...
      iex> original_error = Jido.Action.Error.execution_error("Failed to process payment")
      iex> Jido.Action.Error.compensation_error(original_error, %{
      ...>   compensated: true,
      ...
      %Jido.Action.Error{
        ...
        details: %{
          compensated: true,
          compensation_result: %{refund_id: "ref_123"},
          original_error: %Jido.Action.Error{...}
        }
      }
  ...
  ## Example
      ...
      iex> Jido.Action.Error.to_map(error)
      %{
        type: :validation_error,
  ...
  ## Example
      ...
      iex> stacktrace = Jido.Action.Error.capture_stacktrace()
  ...
  ## Examples
      ...
      iex> Jido.Action.Error.format_nimble_config_error(error, "Action")
  ...
  ## Examples
      ...
      iex> Jido.Action.Error.format_nimble_validation_error(error, "Action")
...
defimpl String.Chars, for: Jido.Action.Error do
  @doc """
  Implements String.Chars protocol for Jido.Action.Error.
  Returns a human-readable string representation focusing on type and message.
  """
  def to_string(%Jido.Action.Error{type: type, message: message, details: details}) do
    base = "[#{type}] #{message}"
  ...
  defp format_details(details) when is_map(details) do
    details
    |> Enum.reject(fn {_k, v} -> match?(%Jido.Action.Error{}, v) end)
...
defimpl Inspect, for: Jido.Action.Error do
  import Inspect.Algebra

  @doc """
  Implements Inspect protocol for Jido.Action.Error.
  ...
  defp format_error_details(%{original_error: %Jido.Action.Error{}} = details, opts) do
